...
import com.example.emurgency13.Maps.HistoryActivity;
...
public class CustomerMapActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String apikey = "AIzaSyCftogS2Kh131Lo8_0hUlksb8nzqm8MWno";
        ...
        mCustomerDatabase.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                if(dataSnapshot.exists() && dataSnapshot.getChildrenCount()>0){
                    ...
                    if(dataSnapshot.child("Ambulance")!=null){
                        mDriverCar.setText(dataSnapshot.child("Ambulance").getValue().toString());
                    }
