package com.example.emurgency13.Maps.Customer;
                ...
                mAuth.createUserWithEmailAndPassword(email, password).addOnCompleteListener(CustomerLoginActivity.this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if(!task.isSuccessful()){
                            Toast.makeText(CustomerLoginActivity.this, "Registered?", Toast.LENGTH_SHORT).show();
                        }else {
        ...
        forgot_password.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (mEmail.getText().toString().isEmpty()){
                    Toast.makeText(CustomerLoginActivity.this, "Enter Email Id.", Toast.LENGTH_SHORT).show();
                }
                else {
                    mAuth.sendPasswordResetEmail(mEmail.getText().toString());
                    Toast.makeText(CustomerLoginActivity.this, "Password reset link sent to " + mEmail.getText().toString(), Toast.LENGTH_SHORT).show();
                }
